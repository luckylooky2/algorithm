...
// - 차이점 : 11049는 누적 합 자체로 답이었지만, 이 문제는 누적 합을 해온 경로의 누적 합의 최소값을 구하는 문제
// - 현재 dp 테이블의 누적 합 이외에, 현재 경로까지의 누적 합의 최소값을 따로 저장할 sum 테이블이 필요
// - 하나의 테이블로는 불가능
// - 현재 칸에 들어올 수 있는 이전 단계까지의 누적 합의 최소값을 구한 뒤, 현재 칸의 min 값과 더해서 sum 테이블을 채움
